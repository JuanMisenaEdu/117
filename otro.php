  ...
  <main class="Exhibicion">
      ...
      <ul class="list">
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            <li class="list_inside">
              <a href="postres.php" class="nav_link nav_link--inside">Postres</a>
            </li>


            <li class="list_inside">
              <a href="tortas.php" class="seleccionado nav_link--inside">Tortas</a>
            </li>
        ...
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            ...
            <li class="list_inside">
              <a href="otro.php" class="seleccionado nav_link--inside">Otros</a>
            </li>
    ...
    <div class="grid">
      <div class="img-exhibicion">
        <img src="css/img/otro/chispadon.jpg">
        <a href="postre.html" class="boton-exhibixion">Dona chispita</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/otro/cupcaketerror.jpg">
        <a href="postre.html" class="boton-exhibixion">Cupcake terrorifico</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/otro/galleta.jpg">
        <a href="postre.html" class="boton-exhibixion">Galleta navideña</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/otro/maeltadaterror.jpg">
        <a href="postre.html" class="boton-exhibixion">Malteada terrorifica</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/otro/paleta.jpg">
        <a href="postre.html" class="boton-exhibixion">Paleta chocolate</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/otro/tortana.jpg">
        <a href="postre.html" class="boton-exhibixion">Torta navideña</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/otro/dona1.jpg">
        <a href="postre.html" class="boton-exhibixion">Combo dona</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/otro/chocodona.jpg">
        <a href="postre.html" class="boton-exhibixion">Choco dona</a>
      </div>
    </div>
  </main>
  <footer>
