  ...
  <main class="Exhibicion">
      ...
      <ul class="list">
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            ...
            <li class="list_inside">
              <a href="#" class="seleccionado nav_link--inside">Tortas</a>
            </li>
        ...
        <li class="lista_item lista_item--click">
          <div class="lista_button lista_button--click">
            ...
            <img src="/Jodienda/css/iconos/flecha.svg" class="list_flecha" loading="lazy">
          </div>
    ...
    <div class="grid">
      <div class="img-exhibicion">
        <img src="css/img/tortas/mani.jpg">
        <a href="postre.html" class="boton-exhibixion">Mani</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/tortas/primavera.jpg">
        <a href="postre.html" class="boton-exhibixion">Primavera</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/tortas/fondat.jpg">
        <a href="postre.html" class="boton-exhibixion">Fondat</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/tortas/chispas.jpg">
        <a href="postre.html" class="boton-exhibixion">Chispa de chocolate</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/tortas/chocolate.jpg">
        <a href="postre.html" class="boton-exhibixion">chocolate</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/tortas/fresa.jpg">
        <a href="postre.html" class="boton-exhibixion">Fresa</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/tortas/cereza.jpg">
        <a href="postre.html" class="boton-exhibixion">Torta</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/tortas/baby.jpg">
        <a href="postre.html" class="boton-exhibixion">Baby shower</a>
      </div>
    </div>
  </main>
  <footer>
