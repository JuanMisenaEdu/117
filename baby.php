  ...
  <main class="Exhibicion">
      ...
      <ul class="list">
        ...
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            ...
            <li class="list_inside">
              <a href="#" class="seleccionado nav_link--inside">Baby shower </a>
            </li>
    ...
    <div class="grid">
      <div class="img-exhibicion">
        <img src="css/img/baby shower/azulado.jpg">
        <a href="postre.html" class="boton-exhibixion">Azulado</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/baby shower/barco.jpg">
        <a href="postre.html" class="boton-exhibixion">Barco</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/baby shower/cinta baby.jpg">
        <a href="postre.html" class="boton-exhibixion">Cinta baby</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/baby shower/buho.jpg">
        <a href="postre.html" class="boton-exhibixion">Buho</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/baby shower/estrellita.jpg">
        <a href="postre.html" class="boton-exhibixion">Estrellita</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/baby shower/paseante baby.jpg">
        <a href="postre.html" class="boton-exhibixion">Paseante baby</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/baby shower/flores.jpg">
        <a href="postre.html" class="boton-exhibixion">Flores</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/baby shower/macaroons.jpg">
        <a href="postre.html" class="boton-exhibixion">Macaroons</a>
      </div>
    </div>
  </main>
  <footer>
