  ...
  <main class="Exhibicion">
      ...
      <ul class="list">
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            ...
            <li class="list_inside">
              <a href="#" class="seleccionado nav_link--inside">Galletas</a>
            </li>
    ...
    <div class="grid">
      <div class="img-exhibicion">
        <img src="css/img/galletas/chispachocolate.jpg">
        <a href="postre.html" class="boton-exhibixion">Chispas de chocolate</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/galletas/navidad.jpg">
        <a href="postre.html" class="boton-exhibixion">Navideñas</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/galletas/macaroons.jpg">
        <a href="postre.html" class="boton-exhibixion">Macaroons</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/galletas/san valentin.jpg">
        <a href="postre.html" class="boton-exhibixion">San valentin</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/galletas/decoradas.jpg">
        <a href="postre.html" class="boton-exhibixion">Decorativas</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/galletas/estrellas.jpg">
        <a href="postre.html" class="boton-exhibixion">Estrellas</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/galletas/chispitas.jpg">
        <a href="postre.html" class="boton-exhibixion">Chispitas</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/galletas/nupcial.jpg">
        <a href="postre.html" class="boton-exhibixion">Nupcial</a>
      </div>
    </div>
  </main>
  <footer>
