  ...
  <main class="Exhibicion">
      ...
      <ul class="list">
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            ...
            <li class="list_inside">
              <a href="#" class="seleccionado nav_link--inside">Cupcakes</a>
            </li>
    ...
    <div class="grid">
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/colores.jpg">
        <a href="postre.html" class="boton-exhibixion">Colores</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/cereza.jpg">
        <a href="postre.html" class="boton-exhibixion">Cereza</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/chantilly.jpg">
        <a href="postre.html" class="boton-exhibixion">Chantilly</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/crema.jpg">
        <a href="postre.html" class="boton-exhibixion">Cremoso</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/chispa.jpg">
        <a href="postre.html" class="boton-exhibixion">Chispa</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/frambuesa.jpg">
        <a href="postre.html" class="boton-exhibixion">Frambuesa</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/chocolate.jpg">
        <a href="postre.html" class="boton-exhibixion">Chocolate</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cupcakes/dulce.jpg">
        <a href="postre.html" class="boton-exhibixion">Dulce</a>
      </div>
    </div>
  </main>
  <footer>
