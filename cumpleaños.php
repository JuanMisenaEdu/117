  ...
  <main class="Exhibicion">
    <div class="navegacion">
      <ul class="list">
        ...
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            <li class="list_inside">
              <a href="cumpleaños.php" class="seleccionado nav_link--inside">Cumpleaños</a>
            </li>
    ...
    <div class="grid">
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/colorada.jpg">
        <a href="postre.html" class="boton-exhibixion">Colorada</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/mandarina.jpg">
        <a href="postre.html" class="boton-exhibixion">Mandarina</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/baby.jpg">
        <a href="postre.html" class="boton-exhibixion">Baby</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/macaroons.jpg">
        <a href="postre.html" class="boton-exhibixion">Macaroons</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/oreo.jpg">
        <a href="postre.html" class="boton-exhibixion">Oreo</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/rosalia.jpg">
        <a href="postre.html" class="boton-exhibixion">Rosalia</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/vela.jpg">
        <a href="postre.html" class="boton-exhibixion">vela</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/cumpleños/alocado.jpg">
        <a href="postre.html" class="boton-exhibixion">Alocado</a>
      </div>
    </div>
  </main>
  <footer>
