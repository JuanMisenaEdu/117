  ...
  <main class="Exhibicion">
      ...
      <ul class="list">
        ...
        <li class="lista_item lista_item--click">
          ...
          <ul class="list_show">
            ...
            <li class="list_inside">
              <a href="boda.php" class="seleccionado nav_link--inside">Bodas</a>
            </li>
    ...
    <div class="grid">
      <div class="img-exhibicion">
        <img src="css/img/boda/espiral.jpg">
        <a href="postre.html" class="boton-exhibixion">Espiral</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/boda/figura.jpg">
        <a href="postre.html" class="boton-exhibixion">Figura 1</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/boda/fresa.jpg">
        <a href="postre.html" class="boton-exhibixion">Fresa</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/boda/love.jpg">
        <a href="postre.html" class="boton-exhibixion">Love</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/boda/rose.jpg">
        <a href="postre.html" class="boton-exhibixion">Rose</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/boda/figura2.jpg">
        <a href="postre.html" class="boton-exhibixion">Figura 2</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/boda/sirenita.jpg">
        <a href="postre.html" class="boton-exhibixion">Sirenita</a>
      </div>
      <div class="img-exhibicion">
        <img src="css/img/boda/white.jpg">
        <a href="postre.html" class="boton-exhibixion">White</a>
      </div>
    </div>
  </main>
  <footer>
